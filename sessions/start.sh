#!/bin/sh
set -eu
export HOME=/home/bw XDG_RUNTIME_DIR=/tmp/runtime-bw NO_COLOR=1
cd "$HOME"
...
filter=$!
browser-wayland --listen 0.0.0.0:19443 --rtc-port 19443 --software-encoding --elements > "$XDG_RUNTIME_DIR/output" 2>&1 &
desktop=$!
